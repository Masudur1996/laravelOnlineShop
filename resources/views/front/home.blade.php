            ...
            <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel"
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset="{{ asset('front-asset/images/carousel-1-m.jpg') }}" />
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('front-asset/images/carousel-1.jpg') }}" />
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset="{{ asset('front-asset/images/carousel-2-m.jpg') }}" />
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('front-asset/images/carousel-2.jpg') }}" />
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset="{{ asset('front-asset/images/carousel-3-m.jpg') }}" />
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('front-asset/images/carousel-3.jpg') }}" />
                            <img src="{{ asset('front-asset/images/carousel-2.jpg') }}" alt="" />
                        </picture>
                    ...
                    @if (categories()->isNotEmpty())
                        @foreach (categories() as $category)
                            <div class="col-lg-3">
                                <div class="cat-card">
                                    <div class="left">
                                        <img src="{{ asset('uploads/images/category/thumbs/' . $category->image) }}"
                                            alt="" class="img-fluid">
                                    </div>
                                    <div class="right">
                                        <div class="cat-data">
                            ...
                            <div class="col-md-3">
                                <div class="card product-card">
                                    ...
                                    <div class="card-body text-center mt-3">
                                        <a class="h6 link" href="product.php">{{ $featuredProduct->name }}</a>
                        ...
                        @foreach ($latestProducts as $latestProduct)
                            <div class="col-md-3">
                                <div class="card product-card">
                                    ...
                                    <div class="card-body text-center mt-3">
                                        <a class="h6 link" href="product.php">{{ $latestProduct->name }}</a>
                                        <div class="price mt-2">
